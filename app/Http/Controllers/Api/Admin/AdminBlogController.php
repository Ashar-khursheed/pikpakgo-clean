...
class AdminBlogController extends Controller
{
     ...
     *         @OA\Property(property="slug",             type="string",  example="travel-tips",  description="Auto-generated from name if omitted"),
     ...
     *         @OA\Property(property="slug",             type="string",  example="top-10-beach-destinations-2027", description="Auto-generated if omitted"),
     *         @OA\Property(property="blog_category_id", type="integer", example=1),
     *         @OA\Property(property="excerpt",          type="string",  example="Discover the world's most beautiful beaches…"),
     *         @OA\Property(property="content",          type="string",  description="Full HTML or Markdown content"),
     *         @OA\Property(property="featured_image",   type="string"),
     *         @OA\Property(property="gallery",          type="array",   @OA\Items(type="string")),
     *         @OA\Property(property="tags",             type="array",   @OA\Items(type="string"), example={"beach","travel","2027"}),
     ...
     *         @OA\Property(property="meta_title",       type="string",  description="Defaults to post title"),
     *         @OA\Property(property="meta_description", type="string",  description="Defaults to excerpt"),
     *         @OA\Property(property="og_title",         type="string"),
     *         @OA\Property(property="og_description",   type="string"),
     *         @OA\Property(property="og_image",         type="string",  description="Defaults to featured_image"),
     ...
     *         @OA\Property(property="schema_markup",    type="object",  description="Custom JSON-LD — auto-generates BlogPosting schema if omitted")
     *     )),
